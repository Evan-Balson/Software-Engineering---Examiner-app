...
root = tk.Tk()
root.title("Software Architecture & Design Exam App")
...
def generate_question():
    ...
    prompt = f"""
        You are a Software Architecture & Design exam question generator. Generate ONE multiple-choice question in the style of: **{style}**.
        Choose a topic such as: 
        - architectural patterns (e.g., layered, MVC, pipes-and-filters, client-server, blackboard),
        - component-based design,
        - interface design (provided/required interfaces, UML2),
        - dependency inversion and Clean Architecture (SRP, OCP, LSP, ISP, DIP),
        - software quality attributes (e.g., modularity, reusability, maintainability),
        - architecture description and configuration (ADLs, compound components),
        - architectural decision-making based on requirements (e.g., 3-tier, domain modeling),
        - service-oriented architecture and web services (REST/SOAP, service brokers, orchestration).
